...
Route::middleware(['auth'])->group(function () {
    ...
    // Employee Scoring routes - accessible by Admin
        Route::prefix('penilaian_karyawan')->group(function () {
            ...
            Route::get('/export-debug', [PenilaianKaryawanController::class, 'exportDebug'])->name('penilaian_karyawan.export-debug');
            Route::get('/test-export', [PenilaianKaryawanController::class, 'testExport'])->name('penilaian_karyawan.test-export');
...
Route::middleware(['auth'])->group(function () {
    Route::get('/hasil_penilaian', [PenilaianKaryawanController::class, 'results'])->name('results.index');
    Route::get('/hasil_penilaian/ranking', [PenilaianKaryawanController::class, 'resultsRanking'])->name('results.ranking');
    Route::get('/hasil_penilaian/export', [PenilaianKaryawanController::class, 'resultsExport'])->name('results.export');
    Route::get('/hasil_penilaian/summary', [PenilaianKaryawanController::class, 'getResultsSummary'])->name('results.summary');
    Route::get('/hasil_penilaian/saw-details', [PenilaianKaryawanController::class, 'getSAWDetails'])->name('results.saw-details');
    Route::get('/hasil_penilaian/{employee}/show', [PenilaianKaryawanController::class, 'resultsShow'])->name('results.show');
});
