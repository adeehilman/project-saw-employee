@extends('inc.main')
@section('title', 'Detail Penilaian - ' . $employee->nama_karyawan)
@section('pages-css')
...
@section('pages-script')
    ...
    <script>
        ...
        function processExport() {
            ...
            // Build URL
            let url = `{{ route('penilaian_karyawan.export') }}?format=${format}&export_type=detail&employee_id=${employeeId}`;
