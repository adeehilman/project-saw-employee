...
<body>
    ...
    <div class="position-absolute pos-bottom pos-left pos-right p-3 text-center text-white">
        <div class="row">
            <div class="col col-sm-12 text-center text-primary">
                {{ $profileApp->app_tahun ?? '' }} © Powered By {{ $profileApp->app_pengembang ?? '' }}
            </div>
        </div>
    </div>
    ...
    <!-- BEGIN Color profile -->
    <!-- area ini tersembunyi dan tidak akan terlihat di layar atau pembaca layar -->
    <!-- kita menggunakan ini hanya untuk referensi warna CSS untuk hal-hal JS -->
